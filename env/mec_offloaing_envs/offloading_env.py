...
class Resources(object):
    ...
    此类表示 MEC 服务器和移动设备（计算资源）

    Args:
        mec_process_capable: computation capacity of the MEC server MEC服务器的计算能力
        mobile_process_capable: computation capacity of the mobile device 移动设备的计算能力
        bandwidth_up: wireless uplink band width 无线上行带宽
        bandwidth_dl: wireless downlink band width 无线下行带宽
    """
